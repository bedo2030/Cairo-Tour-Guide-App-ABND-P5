...
public class RestaurantFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        locationObjects.add(new LocationCustomClass(getString(R.string.restaurant_opasta_title),
                R.drawable.restaurant_opasta,
                getString(R.string.restaurant_opasta_description),
                getString(R.string.restaurant_opasta_address)));

        locationObjects.add(new LocationCustomClass(getString(R.string.restaurant_zooba_title),
                R.drawable.restaurant_zooba,
                getString(R.string.restaurant_zooba_description),
                getString(R.string.restaurant_zooba_address)));

        locationObjects.add(new LocationCustomClass(getString(R.string.restaurant_maison_title),
                R.drawable.restaurant_maison,
                getString(R.string.restaurant_maison_description),
                getString(R.string.restaurant_maison_address)));
